  ...
  <main className="about-main">
    <div style={{ textAlign: 'center', marginTop: 24 }}>
      <img
        ...
        style={{ width: 90, height: 90, borderRadius: '50%', marginBottom: '1em', boxShadow: '0 2px 12px rgba(0,0,0,0.12)' }}
      />
      <h1 style={{ margin: '0.25em 0 0.25em 0', fontWeight: 'bold', fontSize: '2.2em' }}>
        PAWS Web Tool
      </h1>
    ...
    <section>
      ...
      <p style={{ fontSize: '1.08em', margin: '1.2em 0' }}>
        The <b>PAWS Web Tool</b> (Prediction of Aptamers Without SELEX) is an interactive online platform for the generation, analysis, and optimization of RNA aptamers. It enables users to randomly generate candidate aptamers with customizable constraints on sequence length, GC%, and melting temperature (Tm). The tool also supports both regional and single-nucleotide point mutations for in silico aptamer optimization.
      </p>
    </section>
